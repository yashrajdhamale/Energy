...
function updateTotals() {
  ...
  if (document.querySelector('#e7-meter').checked) {
    ...
    let single = document.querySelector("#single-units").value;
    console.log(single);
    var energyTotal = (getValueAsFloat('#single-total')*single);
  }
